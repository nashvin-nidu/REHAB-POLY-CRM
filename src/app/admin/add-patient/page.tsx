    ...
    return (
        <div className="p-6 pb-20 max-w-4xl">
            <div className="flex justify-between items-start mb-6">
                <div>
                    <h1 className="text-[20px] font-bold text-adm-text tracking-tight">Register New Patient</h1>
                </div>
            ...
            <div className="bg-adm-card border border-adm-border rounded-xl p-6 mb-4">
                ...
                <div className="grid grid-cols-2 gap-4 mb-3.5">
                    <div>
                        <label className="block text-[11px] font-semibold text-adm-muted mb-1.5 uppercase tracking-wide">First Name *</label>
                    ...
                    <div>
                        <label className="block text-[11px] font-semibold text-adm-muted mb-1.5 uppercase tracking-wide">Last Name *</label>
                ...
                <div className="grid grid-cols-2 gap-4 mb-3.5">
                    <div>
                        <label className="block text-[11px] font-semibold text-adm-muted mb-1.5 uppercase tracking-wide">Date of Birth *</label>
                    ...
                    <div>
                        <label className="block text-[11px] font-semibold text-adm-muted mb-1.5 uppercase tracking-wide">Gender</label>
                ...
                <div className="grid grid-cols-2 gap-4 mb-2">
                    <div>
                        <label className="block text-[11px] font-semibold text-adm-muted mb-1.5 uppercase tracking-wide">Phone</label>
                    ...
                    <div>
                        <label className="block text-[11px] font-semibold text-adm-muted mb-1.5 uppercase tracking-wide">Email</label>
            ...
            <div className="bg-adm-card border border-adm-border rounded-xl p-6 mb-6">
                ...
                <div className="grid grid-cols-2 gap-4 mb-3.5">
                    <div>
                        <label className="block text-[11px] font-semibold text-adm-muted mb-1.5 uppercase tracking-wide">Injury Level *</label>
                    ...
                    <div>
                        <label className="block text-[11px] font-semibold text-adm-muted mb-1.5 uppercase tracking-wide">AIS Classification *</label>
                ...
                <div className="grid grid-cols-2 gap-4 mb-3.5">
                    <div>
                        <label className="block text-[11px] font-semibold text-adm-muted mb-1.5 uppercase tracking-wide">Assigned Therapist</label>
                    ...
                    <div>
                        <label className="block text-[11px] font-semibold text-adm-muted mb-1.5 uppercase tracking-wide">Program</label>
                ...
                <div>
                    <label className="block text-[11px] font-semibold text-adm-muted mb-1.5 uppercase tracking-wide">Clinical Notes</label>
                    <textarea name="notes" value={formData.notes} onChange={handleChange} placeholder="ASIA scores, precautions, assistive devices..." className="w-full bg-adm-surface border border-adm-border rounded-md px-3 py-2 text-xs text-adm-text outline-none focus:border-adm-accent transition-colors min-h-[80px] font-sora" />
                </div>
            </div>
